...
const Hero = () => {
  return (
    <section className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden pt-16">
      <div className="absolute inset-0 bg-gradient-to-br from-blue-50 to-purple-50 animated-bg -z-10"></div>
      ...
      <div className="container px-4 mx-auto text-center">
        <p className="inline-block mb-4 px-3 py-1 text-sm bg-primary/10 text-primary rounded-full fade-up">
          Hello, I'm a Software Engineer
        </p>
        
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 tracking-tight font-serif fade-up animation-delay-100">
          Kanishk <span className="text-primary">Saini</span>
        </h1>
        
        <p className="max-w-2xl mx-auto text-lg text-foreground/80 mb-8 fade-up animation-delay-200">
        ...
        <div className="mt-16 fade-up animation-delay-400">
          <a 
            href="#about"
            className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-background shadow-md hover:shadow-lg transition-all duration-300 border border-border animate-bounce"
